...
from linrouter_server.application import DEFAULT_CONFIG_FILE, DEFAULT_PUBLIC_API_KEY, DEFAULT_START_PORT, create_server
from linrouter_desktop.platform import get_platform
...
class LinRouterTray:
    def __init__(
        ...
        self.settings_store = SettingsStore(self.config_path, extra_defaults=DESKTOP_SETTINGS)
        self.optional_capabilities = DesktopCapabilities(get_platform(), self.settings_store)
