...
用法：
    python packaging/desktop/tools/generate_icon.py win32 packaging/desktop/resources/win32/LinRouter.ico
    python packaging/desktop/tools/generate_icon.py darwin packaging/desktop/resources/darwin/LinRouter.icns
"""
