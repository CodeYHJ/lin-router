...
class ExecutionDependencies(Protocol):
    ...
    def _classify_candidate_error(self, status_code: Optional[int], raw: str, error_kind: str = "http") -> CandidateErrorClassification: ...
    ...
    def _waf_blocked_suffix(self, classification: CandidateErrorClassification, group: Any) -> str: ...
