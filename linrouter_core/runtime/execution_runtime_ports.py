...
class StreamLifecyclePort:
    def __init__(self, *, idle_timeout: Callable[[Any], int], readline: Callable[..., bytes], response_usage: Callable[[bytes], tuple[int, int, int, int, int]], chunk_usage: Callable[[bytes], tuple[int, int, int, int, int]], mark_timeout: Callable[..., int]) -> None:
        self._idle_timeout = idle_timeout; self._readline = readline; self._response_usage = response_usage; self._chunk_usage = chunk_usage; self._mark_timeout = mark_timeout
